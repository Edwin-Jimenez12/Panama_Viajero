...
function BottomBanner({ onLogoClick }) {
    return (
        <div className="mt-20 bg-blue-900 py-10 shadow-[0_-3px_12px_rgba(0,0,0,0.08)] shadow-black/50  ">
            <div className="max-w-6xl mx-auto  flex flex-col items-center gap-5  font-serif text-white ">
