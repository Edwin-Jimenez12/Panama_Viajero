        ...
        <div className="relative bg-brand-soft text-brand-charcoal">
                    ...
                    <div className="flex w-max animate-marquee-right hover:[animation-play-state:paused]">
                        {[0, 1].map((grupo) => (
                            <div
                                ...
                                aria-hidden={grupo === 1}
                            >
                                {bocasDelToro.actividades.map((actividad) => (
                                    <button
                                        key={`${grupo}-${actividad}`}
                                        type="button"
            ...
            <div className="flex flex-col gap-5">
                ...
                <div className="mx-auto flex max-w-6xl flex-wrap justify-center gap-4 md:gap-8">
                    {bocasDelToro.lugaresDestacados.map((lugar) => (
                        <a key={lugar.id} className="w-[195px] transition hover:scale-105 md:w-[350px]">
                            ...
                            <img
                                ...
                                onClick={() => navigate('../bocas-del-toro/places/' + lugar.id)}
                            />
                            </div>
                        </a>
                    ))}
            ...
            <section className="mx-auto my-10 w-full max-w-6xl px-4 py-16">
                <iframe
                    src={bocasDelToro.ubicacionProvincia.src}
                    title={`Mapa de ${bocasDelToro.nombre}`}
