...
export const almirante = {
    ...
    nombre: 'Almirante',
    banner: {
        src: `${almiranteImageBase}/banner/bg-almirante.webp`,
        alt: 'Banner de Almirante',
    },
    gallery: [
        `${almiranteImageBase}/banner/bg-almirante.webp`,
        `${almiranteImageBase}/gallery/g1-almirante.webp`,
        `${almiranteImageBase}/gallery/g2-almirante.webp`,
        `${almiranteImageBase}/gallery/g3-almirante.webp`,
        `${almiranteImageBase}/gallery/g4-almirante.webp`,
        `${almiranteImageBase}/gallery/g5-almirante.webp`,
        `${almiranteImageBase}/gallery/g6-almirante.webp`,
        `${almiranteImageBase}/gallery/g7-almirante.webp`,
        `${almiranteImageBase}/gallery/g8-almirante.webp`,
        `${almiranteImageBase}/gallery/g9-almirante.webp`,
